...
export default function Footer() {
  return (
    <footer className="container max-w-7xl mx-auto w-full px-4 py-10 border-t">
      <div className="flex flex-col md:flex-row justify-between items-center mb-8">
        <div className="flex flex-wrap justify-center md:justify-start gap-4 md:gap-6 mb-6 md:mb-0">
          {/* PRICING */}
          <Link
            href={"/#pricing"}
        ...
        <div className="flex gap-8">
          {/* YOUTUBE */}
          <Link
            href="https://www.youtube.com/@maphub-co?utm_source=maphub.co"
            target="_blank"
          ...
          >
            <svg viewBox="0 0 512 512" className="size-8">
              <g>
                <path
                  className="fill-current group-hover:fill-[#ff0033] transition-colors"
                ...
                <path
                  className="fill-background-primary group-hover:fill-[#ffffff] transition-colors"
          ...
          {/* DISCORD */}
          <Link
            href="https://discord.gg/ufqVjqpVGw?utm_source=maphub.co"
            target="_blank"
            className="flex items-center group"
            onClick={() =>
              track("link_clicked", {
          ...
          >
            <svg
              viewBox="0 0 512 512"
              className="size-8 fill-current group-hover:fill-[#5865f2] transition-colors"
            >
              <g>
      ...
      <div className="text-sm pt-8 flex flex-col md:flex-row justify-between items-center">
        <p className="text-muted-foreground">
          © 2025 Meteory. All rights reserved
        </p>
      </div>
    </footer>
  );
